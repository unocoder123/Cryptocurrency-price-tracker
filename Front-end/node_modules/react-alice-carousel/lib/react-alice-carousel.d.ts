...
import { AnimationType, AutoplayDirection, EventObject, EventType, Props, SlideTo, State } from 'react-alice-carousel/lib/types';
export * from 'react-alice-carousel/lib/types';
export default class AliceCarousel extends React.PureComponent<Props, State> {
    static defaultProps: {
        ...
        autoPlayStrategy: import("react-alice-carousel/lib/types").AutoPlayStrategy;
        children: undefined;
        controlsStrategy: import("react-alice-carousel/lib/types").ControlsStrategy;
    ...
    _updateComponent(props?: Readonly<Props>): void;
